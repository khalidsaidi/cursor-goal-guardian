...
type PolicySeverity = "HIGH_RISK" | "WARN" | "PERMIT_REQUIRED" | "ALLOWED";
...
type GoalGuardianPolicy = {
  ...
  alwaysAllow: PatternPolicy;
  highRiskPatterns: PatternPolicy;
  warningConfig: {
...
server.registerTool(
  ...
  {
    description:
      "Issue a short-lived permit token tied to a step_id from guardian_check_step. The Cursor hook reads permits from .ai to assess alignment and provide advisory guidance.",
    inputSchema: {
